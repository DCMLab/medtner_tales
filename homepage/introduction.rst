...
* `Nikolai Medtner – Tales <https://github.com/DCMLab/medtner_tales/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first tale has the following files:
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/medtner_tales/issues>`__ and feel free to fork and submit pull requests.
